...
def train_and_dev(city='ld', pre_days=5, gap=0, loss_function="huber_loss", total_iteractions=0):
    '''
    ...
    output_features = []
    if city == 'ld':
        output_features = ['BL0_PM10', 'BL0_PM2.5', 'CD1_PM10', 'CD1_PM2.5',
                           'CD9_PM10', 'CD9_PM2.5', 'GN0_PM10', 'GN0_PM2.5',
                           'GN3_PM10', 'GN3_PM2.5', 'GR4_PM10', 'GR4_PM2.5',
                           'GR9_PM10', 'GR9_PM2.5', 'HV1_PM10', 'HV1_PM2.5',
                           'KF1_PM10', 'KF1_PM2.5', 'LW2_PM10', 'LW2_PM2.5',
                           'MY7_PM10', 'MY7_PM2.5', 'ST5_PM10', 'ST5_PM2.5',
                           'TH4_PM10', 'TH4_PM2.5']

        # output_features = ['BL0_PM10 (ug/m3)', 'BL0_PM2.5 (ug/m3)', 'CD1_PM10 (ug/m3)', 'CD1_PM2.5 (ug/m3)', 'CD9_PM10 (ug/m3)', 'CD9_PM2.5 (ug/m3)', 'GN0_PM10 (ug/m3)', 'GN0_PM2.5 (ug/m3)', 'GN3_PM10 (ug/m3)', 'GN3_PM2.5 (ug/m3)', 'GR4_PM10 (ug/m3)', 'GR4_PM2.5 (ug/m3)', 'GR9_PM10 (ug/m3)', 'GR9_PM2.5 (ug/m3)', 'HV1_PM10 (ug/m3)', 'HV1_PM2.5 (ug/m3)', 'KF1_PM10 (ug/m3)', 'KF1_PM2.5 (ug/m3)', 'LW2_PM10 (ug/m3)', 'LW2_PM2.5 (ug/m3)', 'MY7_PM10 (ug/m3)', 'MY7_PM2.5 (ug/m3)', 'ST5_PM10 (ug/m3)', 'ST5_PM2.5 (ug/m3)', 'TH4_PM10 (ug/m3)', 'TH4_PM2.5 (ug/m3)']
    else:
        for station in station_list:
...
if __name__   == '__main__':
    aver_smapes_best, model_preds_on_dev, dev_y_original, model_preds_on_test, output_features = train_and_dev('bj')
    print(output_features)
    print(model_preds_on_test.shape)
    np.save("filename.npy", model_preds_on_test)
    # b = np.load("filename.npy")
    generator_result(model_preds_on_test, 'bj')
