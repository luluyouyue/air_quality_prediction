...
from eval_utils.eval_aq_data_util import load_bj_aq_data, load_ld_aq_data
...
def aq_data_preprocess(city="bj"):
    ...
    df_merged.to_csv(test_data_dir + "%s_aq_data.csv" % (city))
    ...
    df_norm.to_csv(test_data_dir + "%s_aq_norm_data.csv" % (city))
