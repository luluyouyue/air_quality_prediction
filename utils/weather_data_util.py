...
path_to_bj_meo = KddConfig.path_to_bj_meo
path_to_ld_meo = KddConfig.path_to_ld_meo
...
def load_bj_grid_meo_data(useful_stations):
    ...
    # print 'meo_dataset.shape:', meo_dataset.shape   out:  (1299124, 7)
...
def load_grid_meo_data(meo_df, useful_stations):
    ...
    return:
          meo_dataset: original meo df
          stations: stations  of the original meo df
          meo_stations: dict of meo, key : station  values: station 's meo
    '''
...
def get_station_locations(stations_df):
    ...
    Agrs : 
        stations_df : a dataframe of all station KDD_CUP_2018.
    Return : 
...
def get_related_meo_dfs(aq_station_nearest_meo_station, bj_meo_all, bj_grid_meo_all):
    '''
    Get a dict with aq_station_name as key and nearest meo_station meo KDD_CUP_2018 as value.
    Args :
